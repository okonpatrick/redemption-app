  ...
  return (
    <div className="w-full pt-5 px-4 mb-8 mx-auto ">
      <div className="text-sm text-gray-700 py-1">
         copyright @ <a className="text-gray-700 font-semibold" href="https://www.material-tailwind.com/docs/react/sidebar?ref=tailwindcomponents" target="_blank">Redemption App</a> by <a href="https://www.creative-tim.com?ref=tailwindcomponents" className="text-gray-700 font-semibold" target="_blank"> Fed Govt. Nigeria</a>.
      </div>
    </div>
  );
}
